...
function SidebarNav({ expanded, onNavigate, onClose }: SidebarNavProps) {
...
export function StudentSidebar() {
  const { isCollapsed, isMobileOpen, toggleSidebar, closeMobileSidebar } = useStudentShell()

  return (
    <>
      {/* Mobile: hidden by default, slides over content */}
      <div className="md:hidden">
        ...
        <aside
          ...
          aria-hidden={!isMobileOpen}
        >
          <SidebarNav expanded onNavigate={closeMobileSidebar} onClose={closeMobileSidebar} />
        </aside>
      </div>

      {/* Desktop: persistent collapsed/expanded sidebar */}
      <aside
        className={cn(
      ...
      >
        ...
        <SidebarNav expanded={!isCollapsed} />
      </aside>
    </>
  )
}
